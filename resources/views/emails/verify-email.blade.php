...
<x-emails.layout
    ...
    :logo="$companyLogo"
    :greeting="$userName"
    :title="$title ?? 'Verifikasi Alamat Email Anda'"
    :content="$emailContent ?? 'Terima kasih telah mendaftar. Silakan klik tombol di bawah untuk memverifikasi alamat email Anda.'"
