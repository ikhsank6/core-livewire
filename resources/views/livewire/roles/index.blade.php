    ...
    <div
        ...
        <div class="px-6 py-5 border-b border-zinc-200 dark:border-zinc-800">
            <div class="sm:flex sm:items-center justify-between">
                <div>
                    <h1 class="text-xl font-bold text-zinc-900 dark:text-white">Roles</h1>
                    <p class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">Define and manage user roles and their
                        associated
                        permissions.</p>
                </div>
                ...
                <x-ui.table.tbody>
                    @forelse($roles as $role)
                        <x-ui.table.tr>
                            ...
                            <x-ui.table.td>
                                <code
                                    class="text-xs bg-zinc-100 dark:bg-zinc-800 px-1.5 py-0.5 rounded text-[#1b84ff] border border-zinc-200 dark:border-zinc-700">{{ $role->slug }}</code>
                            </x-ui.table.td>
                            <x-ui.table.td>
                                <span
                                    class="text-zinc-500 dark:text-zinc-400">{{ Str::limit($role->description, 50) }}</span>
                            </x-ui.table.td>
                            <x-ui.table.td>
