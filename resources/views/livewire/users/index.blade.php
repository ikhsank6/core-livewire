...
<div>
    <div class="sm:flex sm:items-center justify-between mb-8">
        <div>
            <h1 class="text-2xl font-bold text-[#1b1c22] dark:text-white">Users</h1>
            <p class="mt-1 text-sm text-[#99a1b7] dark:text-[#6d6d80]">Manage your team members and their account
                permissions.</p>
        </div>
                    ...
                    <x-ui.table.td>
                        <div class="flex flex-col gap-1">
                            ...
                            @if($user->roles->count() > 1)
                                <span class="text-[10px] text-[#99a1b7] font-medium">+{{ $user->roles->count() - 1 }} other
                                    roles</span>
                            @endif
                        </div>
                    </x-ui.table.td>
                    <x-ui.table.td>
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex flex-col">
                                <span class="font-bold text-[#1b1c22] dark:text-white">{{ $user->name }}</span>
                                <span class="text-xs text-[#99a1b7]">Indonesia/Jakarta</span>
                            </div>
                        </div>
                    </x-ui.table.td>
                    <x-ui.table.td>
