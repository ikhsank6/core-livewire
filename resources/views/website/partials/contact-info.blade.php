    ...
    @if($aboutUs?->address)
        <div class="flex items-start gap-4">
            ...
            <div>
                ...
                <p class="text-gray-400 text-sm">{{ $aboutUs->address }}</p>
            </div>
        </div>
    @endif
    @if($aboutUs?->phone)
        <div class="flex items-start gap-4">
            ...
            <div>
                ...
                <p class="text-gray-400 text-sm">{{ $aboutUs->phone }}</p>
            </div>
        </div>
    @endif
    @if($aboutUs?->email)
        <div class="flex items-start gap-4">
            ...
            <div>
                ...
                <p class="text-gray-400 text-sm">{{ $aboutUs->email }}</p>
            </div>
        </div>
    @endif
</div>
<div class="flex gap-4 mt-8">
    @if($aboutUs?->facebook)<a href="{{ $aboutUs->facebook }}" target="_blank"
        class="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center hover:bg-primary transition-colors"><svg
    ...
    @if($aboutUs?->linkedin)<a href="{{ $aboutUs->linkedin }}" target="_blank"
        class="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center hover:bg-primary transition-colors"><svg
            class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            <path
